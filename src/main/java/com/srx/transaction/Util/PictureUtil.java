...
public class PictureUtil {
    ...
    public static String secretId = "AKID3vWqtgCRP6YibDYdQwCCvNYS5RWLs87T";
    public static String secretKey = "7xWoqb5HCqDI7fvuc3D5g15sOdbIirjK";

    // 指定文件将要存放的存储桶
    private static String bucketName = "transaction-1312234723";
